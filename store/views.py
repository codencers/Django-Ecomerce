...
def product_map(request):
    chillers = [
        {
            ...
            'area': 'Hazratganj',
            'location': 'Hazratganj Market, Near GPO',
            'distance': 1.2,
            'rating': 4.8,
            'reviews': 124,
            'now': True,
        ...
        },
        {
            ...
            'area': 'Gomti Nagar',
            'location': 'Gomti Nagar Extension Sector 12',
            'distance': 2.5,
            'rating': 4.9,
            'reviews': 89,
            'now': False,
    ...
    return render(request, 'product_map.html', {'chillers': chillers})


def seller(request):
    products = Product.objects.all()
    return render(request, 'sellers.html',{'products': products})
